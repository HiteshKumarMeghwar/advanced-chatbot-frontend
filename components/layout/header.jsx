...
export default function Header({ sidebar = false, sidebarOpen, setSidebarOpen, protectedRoute = false }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-t bg-card/95 backdrop-blur">
      <div className="mx-auto flex h-12 max-w-11xl items-center justify-between px-1 sm:px-6 lg:px-8">
